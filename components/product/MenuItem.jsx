  ...
  return (
    <div className="bg-secondary rounded-3xl">
      <div className="w-full  bg-[#f1f2f3] h-[210px] grid place-content-center rounded-bl-[46px] rounded-tl-2xl rounded-tr-2xl">
        <div className="relative w-full  h-48 aspect-[4/3] hover:scale-110 transition-all overflow-hidden ">
          <Image src={img} alt="" layout="fill"  className="object-contain rounded-3xl" />
        </div>
      </div>
